        ...
        <ul>
            ...
            <li data-index="rs-901"
                ...
                <img src="/assets/1.png" alt=""
                    data-lazyload="/assets/1.png" data-bgposition="center center"
                ...
                <div class="tp-caption tp-resizeme" id="slide-901-layer-5"
                    ...
                    <a href="/about" class="site-button-secondry btn-effect">More About</a>
                </div>
            </li>
            ...
            <li data-index="rs-902"
                ...
                <img src="/assets/2.png" alt=""
                    data-lazyload="/assets/2.png" data-bgposition="center center"
                    data-bgfit="cover" data-bgparallax="4" class="rev-slidebg" data-no-retina>
                <!-- LAYERS -->
                <!-- LAYER NR. 1 [ for overlay ] -->
                ...
                <div class="tp-caption   tp-resizeme"
                    ...
                    data-paddingbottom="[0,0,0,0]"
                    data-paddingleft="[0,0,0,0]"
                    style="z-index: 13;white-space: normal;font-weight: 700;color:#fff;border-width:0px;font-family: 'Poppins', sans-serif; text-transform:uppercase;">
                ...
                <div class="tp-caption tp-resizeme" id="slide-902-layer-5"
                    ...
                    <a href="/about" class="site-button-secondry btn-effect" style="margin-top: 40px;">More About</a>
                </div>
            </li>
            ...
            <li data-index="rs-903"
                ...
                data-easeout="default"
                data-masterspeed="default"
                data-thumb="/assets/images/main-slider/slider1/slide3-thumb.jpg"
                data-rotate="0"
                data-fstransition="fade"
                data-fsmasterspeed="300"
                data-fsslotamount="7"
                ...
                <div class="tp-caption   tp-resizeme" id="slide-903-layer-4"
                    ...
                    style="z-index: 13;
                        ...
                        color:#111;
                        border-width:0px;font-family: 'Poppins', sans-serif;">
                    Due to our dedication and distinctive manner of operation, we provide business with express / deliveries by road, rail, air, sea transportation.
                </div>
