        ...
        <div class="card-body">
            ...
            <div class="mb-4 row align-items-center">
                <div class="col">
                    ...
                    <p class="text-muted">Fill the form below to create a client account</p>
                </div>
                <div class="col-auto">
            ...
            <form method="post" action="{{ route('affiliate.dashboard.clients.save') }}">
