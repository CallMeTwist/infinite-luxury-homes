                    ...
                    <div class="col-lg-12">
                        <div class="prt-page-title-row-heading">
                            ...
                            <div class="page-title-heading">
                                <h2 class="title">Custom Extensions and Renovation</h2>
                            </div>
                            <div class="breadcrumb-wrapper">
                                ...
                                <span class="action">Custom Extensions and Renovation</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-8 content-area">
                        <div class="prt-service-single-content-area">
                            <div class="prt_fatured_image-wrapper single-img mb-40 res-575-mb-30">
                                <img width="857" height="350" class="img-fluid border-rad_10" src="/assets/images/services/services-02.jpg" alt="services-img">
                            </div>
                            <div class="prt-service-description">
                                <h3>Description</h3>
                                <p>Transform your existing space with expertly crafted home extensions and renovations that enhance both functionality and style. Whether it's expanding your living area, modernizing interiors, or restoring classic features, we tailor every project to your unique needs. Our team seamlessly integrates new additions with existing structures, maintaining aesthetic harmony and structural integrity.</p>
                                <p>From conceptual planning to final execution, we handle every stage with meticulous attention to detail, ensuring that your renovated space reflects your vision while improving comfort, efficiency, and market value. With high-quality materials, innovative solutions, and skilled craftsmanship, we turn your home into a masterpiece of modern living.</p>
                                            ...
                                            <div class="featured-icon-box icon-align-before-content style2">
                                                <div class="featured-content">
                                                    ...
                                                    <div class="featured-title">
                                                        <h3>Bespoke Home Expansions</h3>
                                                    </div>
                                                    <div class="featured-desc">
                                                        <p>We seamlessly integrate custom extensions that enhance living space, increase property value, and maintain architectural harmony.</p>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            ...
                                            <div class="featured-icon-box icon-align-before-content style2">
                                                <div class="featured-content">
                                                    ...
                                                    <div class="featured-title">
                                                        <h3>Luxury Interior & Exterior Upgrades</h3>
                                                    </div>
                                                    <div class="featured-desc">
                                                        <p>Our renovation services transform homes with high-end finishes, modern layouts, and cutting-edge design elements for a fresh, elegant look.</p>
                                                    </div>
                                                </div>
                                            </div><!-- featured-icon-box end-->
                                        </div>
                        ...
                        <div class="pl-20 res-991-pl-0">
                            <aside class="widget widget-nav-menu with-title">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="{{ route('services.view', 'custom-extensions-and-renovations') }}">Custom Extensions and Renovation</a></li>
