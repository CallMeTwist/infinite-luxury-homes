...
@section('content')
    <div class="site-main">
        ...
        <!--service-section -->
        <section class="prt-row prt-bg service-section02 clearfix">
            <div class="container">
                <div class="row prt-vertical_sep row-equal-height">
                    <div class="col-lg-4 col-md-6 col-sm-12" data-aos="fade-up" data-aos-offset="200" data-aos-duration="1000" data-aos-once="true">
                        <!--featured-icon-box-->
        ...
        <!--bg-base-dark-->
        <section class="prt-row prt-bg bg-base-dark prt-bgimage-yes bg-img4 service-section03 clearfix" >
            <div class="prt-row-wrapper-bg-layer prt-bg-layer bg-base-dark"></div>
            <div class="container" data-aos="fade-up" data-aos-offset="200" data-aos-duration="1000" data-aos-once="true">
                <div class="row row-equal-height">
                    <div class="col-xl-6 col-lg-12">
                        <div class="text-start res-1199-mb-30">
                            <!-- section title -->
        ...
        <!--fid-section -->
        <section class="prt-row prt-bg clearfix">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="prt-client-count-style1">
                            <h2>300k+</h2>
                            <p class="client-text">Happy Clients</p>
                        </div>
                    </div>
                </div>
                <div class="row slick_slider mt-30 res-767-mt-15" data-slick='{"slidesToShow": 5, "slidesToScroll": 1, "arrows":false, "dots":false, "autoplay":true, "infinite":true, "responsive": [{"breakpoint":1201,"settings":{"slidesToShow": 4}}, {"breakpoint":731,"settings":{"slidesToShow": 3,"arrows":false}},{"breakpoint":551,"settings":{"slidesToShow": 2,"arrows":false}}, {"breakpoint":360,"settings":{"slidesToShow": 1}}]}'>
                    <div class="col-lg-3">
